...
def rule28(stock, data: List[dataModel], industryLimitRank: list):
    ...
    for i in range(20):
        ...
        return False
    if stock not in industryLimitRank[0].__iadd__([] if len(industryLimitRank) == 1 else industryLimitRank[1]):
        return True
